 ...
 *
 *  Based On: AutoScaleGadget.cpp
 *      Created on: Dec 19, 2011
 *      Author: Michael S. Hansen
 */

#include "StarterGadget.h"

namespace Gadgetron{

StarterGadget::StarterGadget()
	: histogram_bins_(100)
	, current_scale_(1.0)
	, max_value_(2048)
{
...
int StarterGadget::process_config(ACE_Message_Block* mb) {
    max_value_ = max_value.value();
	return GADGET_OK;
}


int StarterGadget::process(GadgetContainerMessage<ISMRMRD::ImageHeader> *m1, GadgetContainerMessage<hoNDArray<float> > *m2)
{
...
GADGET_FACTORY_DECLARE(StarterGadget)
