...
mkdir -p /home/vscode/.local/share/CMakeTools && \
    echo '[{"name":"GCC-CONDA","compilers":{"C":"/opt/conda/envs/gadgetron-starter/bin/x86_64-conda_cos6-linux-gnu-gcc","CXX":"/opt/conda/envs/gadgetron-starter/bin/x86_64-conda_cos6-linux-gnu-g++"}}]' > /home/vscode/.local/share/CMakeTools/cmake-tools-kits.json && \
